...
//		System.out.println("fName : "+fName);
		...
		/*
			...
			MultypartRequest() : 
				MultipartRequest(서버저장소명, '서버에 저장될 파일의 경로', '서버의 저장될 파일의 최대 용량', '코드변환방식', 기타옵션(파일명중복방지처리등.))
				
				서버 파일시스템의 저장경로 : getRealPath() - 홈디렉토리(webbap)기준으로 설정
		...
		*/
		...
		System.out.println("서버파일 저장 파일명 : " + filesystemName);
