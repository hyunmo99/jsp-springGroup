...
<div class="container">
  ...
  <form action="t08Ok.jsp">
      <div>그림선택
        <select name="img" id="img" class="form-control" xxonchange="imgChange()">
          <option>111</option>
          <option>112</option>
          <option>113</option>
          <option>114</option>
      ...
      <hr/>
      <div>그림선택
        <select name="img2" id="img2" size="5" multiple class="form-control" xxonclick="imgChange2()">
          <option>111</option>
          <option>112</option>
          <option>113</option>
          <option>114</option>
