...
<div class="container">
  ...
  <pre>
  	사용법 : $ {변수/값/객체/수식}
  	용도 : 사용자가 '번수/값/객체/수식'등을 서버로부터 전송받은후에 해당 자료를 '(변수)저장', 계산, 선언등의 처리 용도로 사용. 
  ...
  <hr/>
	...
	<p>폼태그 또는 get방식을 통해서 넘어온 값에 대한 처리를 할 수 있다.(주소?변수1=값1&변수2=값2......)</p>
	<div>주소창의 마지막 파일명 또는 경로명뒤에 '?mbc=20&kbs=50'을 입력후 확인하시오.</div>
	mbc = ${param.mbc}<br/> 
	kbs = ${param.kbs}<br/> 
	...
	<h4>form태그의 post방식을 통한 전송</h4>
	<div>
		<form action="${pageContext.request.contextPath}/j0807/EL" name="myform" method="post">
			<div>성명
