...
<p><br/></p>
<div class="container">
  <h2>JSTL Function/Formatting</h2>
  <pre>
  ...
  <div>
  	...
  	6-3. str변수의값중에서 'o'문자가 들어가 있는 모든 위치?<br/>
  	...
  	6-4. str변수의 값중 'o'는 뒤에서터 몇번째? (?)(split/indexOf/substringAfter/substringBefore으로 검색하기)<br/>
  	...
  	7. 문자열분리(split())? 'o'를 기준으로 분리<br/>
		...
		str변수안의 'o'문자의 개수는? :  ${fn:length(positions)-1}
