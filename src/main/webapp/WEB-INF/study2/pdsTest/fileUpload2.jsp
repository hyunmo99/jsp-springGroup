...
<head>
  ...
  <script>
  	...
  	function fCheck() {
  		...
  		let ext1 = fName1.substring(fName.lastIndexOf(".")+1).toLowerCase();
  		let ext2 = fName2.substring(fName.lastIndexOf(".")+1).toLowerCase();
  		let ext3 = fName3.substring(fName.lastIndexOf(".")+1).toLowerCase();
  		...
  		else if(ext1 != 'jpg' && ext1 != 'gif' && ext1 != 'png' && ext1 != 'zip' && ext1 != 'hwp' && ext1 != 'doc' && ext1 != 'ppt' && ext1 != 'pptx' && ext1 != 'pdf' && ext1 != 'text') {
  			alert("업로드 가능한 파일은 'jpg/gif/png/zip/hwp/doc/ppt/pptx/pdf/txt'파일 입니다.'");
  		}
  		else if(ext2 != 'jpg' && ext2 != 'gif' && ext2 != 'png' && ext2 != 'zip' && ext2 != 'hwp' && ext2 != 'doc' && ext2 != 'ppt' && ext2 != 'pptx' && ext2 != 'pdf' && ext2 != 'text') {
  			alert("업로드 가능한 파일은 'jpg/gif/png/zip/hwp/doc/ppt/pptx/pdf/txt'파일 입니다.'");
  		}
  		else if(ext3 != 'jpg' && ext3 != 'gif' && ext3 != 'png' && ext3 != 'zip' && ext3 != 'hwp' && ext3 != 'doc' && ext3 != 'ppt' && ext3 != 'pptx' && ext3 != 'pdf' && ext3 != 'text') {
  			alert("업로드 가능한 파일은 'jpg/gif/png/zip/hwp/doc/ppt/pptx/pdf/txt'파일 입니다.'");
  		}
  		else {
  			myform.submit();
