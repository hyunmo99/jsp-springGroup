...
insert into board values (default, 'admin', '관리맨', '게시판 서비스를 시작합니다', '즐거운 게시판 생활 되세요', '192.168.50.58', default,default,default,default,default);
select *from board;
...
select* from board where mid like '%h%'; 
...
insert into boardReply values (default, 14, 'hkd12341', '홍장군', default, '192.168.50.58', '댓글연습');
insert into boardReply values (default, 13, 'hkd12341', '홍장군', default, '192.168.50.58', '댓글연습');
