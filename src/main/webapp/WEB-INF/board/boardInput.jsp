	...
	<h2 class=text-center>게시판 글쓰기</h2>
		<form action="BoardInputOk.bo" name="myform" method="post">
			<table class="table">
				...
				<tr>
					<th>글제목</th>
					<td><input type="text" name="title" id="title" placeholder="글제목을 입력하세요" autofocus class="form-control" /></td>
				</tr>
				<tr>
					<th>글내용</th>
				...
				<tr>
					...
					<td>
						...
						<input type="radio" name="openSw" id="openSw1" value="NO"  /> 비공개 &nbsp; 
					</td>
				</tr>
				<tr>
					<td colspan="2" class="text-center">
						...
						<input type="button" value="돌아가기" onclick="location.href='boardList.bo'" class="btn btn-danger me-2" />
					</td>
				</tr>
			</table>
